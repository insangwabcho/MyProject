...
public class goodsDAO {
	//?Ç≠?†ú?õÑ ?ãúÎ¶¨ÏñºÎ≤àÌò∏ ?†ï?†¨ Î©îÏÜå?ìú
	...
	public int updateEa(String name, int textno, int tmpea, int serial) {
		...
		try {
			conn = sangjin.DB.DB.comCon();
			// tmpea(?òÑ?û¨ ?û¨Í≥?)+textno(Ï∂îÍ??ï†?û¨Í≥?)
			int ea = tmpea + textno;
	...
	// JTABLE?óê ?Ñ†?Éù?ïútable ?û¨Í≥†Ï∂ú?†•
	...
	// Î¶¨Ïä§?ä∏?óê TABLE Ï∂úÎ†• Î©îÏÜå?ìú
