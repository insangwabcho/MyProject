...
public class SearchPassword extends JFrame {
	...
	public SearchPassword() {
		...
		btnPSearch = new JButton("찾기");
		btnPSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dao=new JoinDAO();
				String id=tfid.getText();
				String email=tfemail.getText();
				if(dao.searchPassword(id, email)!=null){
					JOptionPane.showMessageDialog(SearchPassword.this, "회원님의 비밀번호 : "+dao.searchPassword(id, email));
				}else{
					JOptionPane.showMessageDialog(SearchPassword.this, "입력 정보를 다시 확인해주세요.");
				}
			}
		});
		btnPSearch.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		btnPSearch.setBounds(342, 178, 76, 27);
